...
class _$MovieDetailModelImpl implements _MovieDetailModel {
  const _$MovieDetailModelImpl(
      ...
      @JsonKey(name: "production_countries")
      final List<ProductionCountries>? productionCountries = const [],
      @JsonKey(name: "release_date") this.releaseDate,
      this.revenue = 0,
      this.runtime = 0,
      @JsonKey(name: "spoken_languages")
      final List<SpokenLanguages>? spokenLanguages = const [],
      this.status = "",
      this.tagline = "",
      this.title = "",
      this.video = false,
  ...
  @override
  String toString() {
    return 'MovieDetailModel(adult: $adult, backdropPath: $backdropPath, budget: $budget, genres: $genres, homepage: $homepage, id: $id, imdbId: $imdbId, originCountry: $originCountry, originalLanguage: $originalLanguage, originalTitle: $originalTitle, overview: $overview, popularity: $popularity, posterPath: $posterPath, productionCompanies: $productionCompanies, productionCountries: $productionCountries, releaseDate: $releaseDate, revenue: $revenue, runtime: $runtime, spokenLanguages: $spokenLanguages, status: $status, tagline: $tagline, title: $title, video: $video, voteAverage: $voteAverage, voteCount: $voteCount)';
  }
...
class _$GenresImpl implements _Genres {
  const _$GenresImpl({this.id, this.name});
...
abstract class _Genres implements Genres {
  const factory _Genres({final int? id, final String? name}) = _$GenresImpl;
...
abstract class _SpokenLanguages implements SpokenLanguages {
  const factory _SpokenLanguages(
      ...
      final String? name}) = _$SpokenLanguagesImpl;
